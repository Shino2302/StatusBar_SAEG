...
using StatusBar_SAEG.Droid.StatusBar;
...
namespace StatusBar_SAEG.Droid.StatusBar
{
    internal class StatusBar : VMStatusBar
    {
        WindowManagerFlags _originarFlags;
